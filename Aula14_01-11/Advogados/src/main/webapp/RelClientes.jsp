...
<body>
  ...
  <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
	...
	<div class="container">
		<table class="table table-dark mt-5 mb-4">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					<a href="editarcliente?id=<%=lista.get(i).getIdcliente()%>"onclick="return confirm('Tem certeza que deseja editar?')">Editar</a>
					&nbsp;|&nbsp; 
					<a href="apagarcliente?id=<%=lista.get(i).getIdcliente()%>"onclick="return confirm('Tem certeza que deseja deletar?')">Apagar</a>
					</td>
				</tr>
		...
		<div class="row">
			<div class="col-md-12">
				<a href="index.jsp"><button class="btn btn-info">Início
						</button></a>
				<a href="CadCliente.jsp"><button class="btn btn-light">⇦ Voltar
						</button></a>
			</div>
		</div>
	</div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-4">
        ...
        <div class="footer-blog">
          ...
          <div>
            <a href="#">Cadastro de advogados</a>
          </div>
  ...
  <div class="container">
    <div class="footer-contact">
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          <h4>E-mail</h4>
          <p>contato@tcadvogados.com</p>
        </div>
        
        <div class="col-md-6">
        
          <h4>Redes Sociais</h4>
          <a href="https://twitter.com/"><i class="fab fa-twitter">X</i></a>
  ...
  <div class="copyright">
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          <div class="copy-text">
            <p>&copy; <a href="#">TC Advogados</a> - Todos os Direitos Reservados.</p>
          </div>
        </div>
