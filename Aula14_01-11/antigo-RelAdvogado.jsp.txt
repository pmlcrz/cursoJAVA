	...
	<table class="table table-dark">
	  ...
	  %>
	    ...
	    <tr>
	      ...
	      <td>
	      <td>
			<a href="editaradvogado?id=<%=lista.get(i).getOab()%>">Editar</a>
			&nbsp;|&nbsp; 
			<a href="apagaradvogado?id=<%=lista.get(i).getOab()%>">Apagar</a>	      
	      </td>
	    </tr>
	 ...
	 <% } %>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<a href="CadAdvogado.jsp"><button class="btn btn-light">⇦ Voltar
						</button></a>
			</div>
		</div>
	</div>
